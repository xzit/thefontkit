export const presets = [
  ...
  },
  {
    ...
    heading: { fontId: "golos-text", weight: 600, size: 28 },
    body: { fontId: "golos-text", weight: 400, size: 18 },
  },
  {
    display: { fontId: "fira-sans", weight: 700, size: 48 },
    heading: { fontId: "fira-sans", weight: 600, size: 28 },
    body: { fontId: "merriweather", weight: 400, size: 18 },
  },
  {
    display: { fontId: "abril-fatface", weight: 400, size: 48 },
    heading: { fontId: "raleway", weight: 600, size: 28 },
